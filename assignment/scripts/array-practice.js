...
let favoriteFoods = ['cheeseburger','mac and cheese', 'wings', 'pizza'];
...
console.log('Added Favorite Dessert:',favoriteFoods);
...
console.log(`Added entree to the beginning: ${entree}`); 
